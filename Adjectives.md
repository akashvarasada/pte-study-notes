...
- What it is: Used to compare two people, things, or groups.

- Rules:

  - Add -er for short words (e.g., taller, heavier).

  - Use more before long words (e.g., more beautiful, more intelligent).

  - Some are irregular (e.g., good $\rightarrow$ better, bad $\rightarrow$ worse).
...
- What it is: Used to compare three or more nouns to show which one has the highest or lowest degree of the quality.

- Rules:

  - Add -est for short words (e.g., tallest, heaviest).

  - Use most before long words (e.g., most beautiful, most intelligent).

  - Irregular forms change completely (e.g., good $\rightarrow$ best, bad $\rightarrow$ worst).
...
## 💡 PTE Quick Tips for Adjectives

1. The "Than" Rule: If you see "than" immediately after a blank in a Fill-in-the-Blanks question, look for a Comparative adjective (ends in -er or has more).

2. The "The" Rule: If you see "the" immediately before a blank, it often signals a Superlative adjective (ends in -est or has most).

3. Double Comparatives/Superlatives Error: Never combine them. Saying "more taller" or "most best" is grammatically incorrect. It should be just taller or best.

## 4. Common Adjective Endings (Suffixes)

You can often identify adjectives in the PTE Reading section by looking at how the word ends. Recognizing these suffixes helps you quickly determine if a word fits a blank that requires a description.
