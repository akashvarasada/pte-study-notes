...
- What it is: Used to describe an action that happened and finished in the past.
...
## 3. $V_3$ (Participle Form)

The participle form is divided into two types:

### $V_3(a)$ Past Participle ($V_1$ + ed / en)
...
## 4. $V_4$ (Singular Form / Present $V_1$ + s/es)
...
1. Subject-Verb Agreement: Look out for $V_1$ vs $V_4$. Plural subjects take $V_1$ (They run), Singular subjects take $V_4$ (He runs).

2. Perfect Tenses: Always use $V_3$ (Past Participle) after has, have, had (e.g., "has spoken", NOT "has spoke").

3. Continuous Tenses: Always use $V_1$+ing after is, am, are, was, were when describing active actions.
